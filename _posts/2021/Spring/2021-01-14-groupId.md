...
&nasp;소프트웨어 개발자는 서드 파티(third party)로 불리기도 한다.

- 하드웨어 생산자가 직접 소프트웨어를 개발하는 경우는  
&nasp;퍼스트 파티,  

&nasp;하드웨어 생산자인 모기업과 자사간의 관계에서의  
&nasp;소프트웨어 개발자라면 보통 세컨드 파티라고 부르며  

&nasp;하드웨어 생산자와 직접적인 관계없이  
&nasp;소프트웨어를 개발하는 회사를  
&nasp;서드 파티라고 부른다.

- 하드웨어 생산자인 모기업과 자사간의 관계  
&nasp;또는 하청관계등이 전혀 관련없는 소프트웨어 개발자를  
&nasp;써드 파티라 부르고  

&nasp;제품의 사용자를 세컨드 파티(2nd party)  
&nasp;그리고 하드웨어 생산자인 모기업과 자사간의 관계  
&nasp;또는 하청관계등 여타의 관계 하에 소프트웨어를 개발하는 업체를  
&nasp;퍼스트 파티라고 표현하는 등  
&nasp;업체별 분야별로 약간씩 서로 다른 사례나 관례를 가지고 있다.
